...
后续本项目的所有核心功能和新功能都将在不改变所有原有功能和用法的情况下转向本人新项目，使用原生http实现，对于从Python启动应用的用户可无缝转移。
请使用python启动的用户移步至新项目：https://github.com/TheValkyrja/VertexClaudeProxy

对于使用其他方式启动的用户，后续测试没有问题之后将会完善其他启动方法。
